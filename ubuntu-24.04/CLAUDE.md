...
| `INSTALL_CONVMV_TIMER` | `false` | systemd-Timer installieren, der `QGIS_PROJECTS_DIR` alle 15 Min. auf Unicode NFC normalisiert (`true`/`false`) — nur relevant, wenn Medien-/Upload-Dateien über einen Mac synchronisiert werden. Siehe [Haupt-README.md: Anhang – Umlaute im Dateinamen (NFD/NFC)](../README.md#anhang-umlaute-im-dateinamen-nfd-nfc-nach-mac-synchronisation) |
