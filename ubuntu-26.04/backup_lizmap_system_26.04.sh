...
# Ubuntu 26.04 LTS (Resolute Raccoon) -- auch für arm64 nutzbar
...
cp -a /etc/php/8.5/fpm/php.ini    "${BACKUP_DIR}/etc/php/" 2>/dev/null || true
cp -a /etc/php/8.5/fpm/pool.d     "${BACKUP_DIR}/etc/php/" 2>/dev/null || true
