...
#              This block is NOT touched by certbot.
#   Block 2 (domain):         karte1.wandelderzeit.ch → certbot adds HTTPS here.
#
# Result:
#   http://<IP>/                     → Lizmap (always, certbot-independent)
#   http://karte1.wandelderzeit.ch/  → Lizmap (before HTTPS) / 301 to HTTPS (after certbot)
#   https://karte1.wandelderzeit.ch/ → Lizmap
